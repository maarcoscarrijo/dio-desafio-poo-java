...
public class Dev {
    ...
    public void inscreverBootcamp(Bootcamp bootcamp) {
        ...
        bootcamp.getDevsInscritos().add(this); //adicionando "este" Dev, no bootcamp
    }
...
//        return this.setConteudosConcluidos.stream().mapToDouble(conteudo -> conteudo.calcularXp()).sum();
    }
